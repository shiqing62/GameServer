...
import { Payload, unionToPayload, unionListToPayload } from '../../game/message/payload.js';
...
static createMessage(builder:flatbuffers.Builder, msgId:number, payloadType:Payload, payloadOffset:flatbuffers.Offset, timeStamp:number):flatbuffers.Offset {
